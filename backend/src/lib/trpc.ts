...
//   ...appContext,
//   me: req.user || null,
//   prisma, // Добавляем PrismaClient в контекст
// });
...
// export const createTrpcRouter = trpc.router;
// export const trpcProcedure = trpc.procedure; // Обычный procedure

// // Логирование запросов (оставляем, чтобы другие файлы не сломались)
// export const trpcLoggedProcedure = trpc.procedure.use(
//   trpc.middleware(async ({ path, type, next, ctx, rawInput }) => {
//     const start = Date.now();
//     const result = await next();
