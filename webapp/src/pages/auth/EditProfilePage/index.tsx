...
const General = ({ formik }: { formik: ReturnType<typeof useForm>['formik'] }) => {
  return (
    <form onSubmit={formik.handleSubmit}>
      <FormItems>
        ...
        <Alert {...formik.alertProps} />
        <Button {...formik.buttonProps}>Сохранить</Button>
      </FormItems>
    </form>
  );
};
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.profile}>
        <img alt="Profile picture" height="150" src={formik.values.avatar || avatarPlaceholder} width="150" />
...
const Avatar = ({ me }: { me: NonNullable<TrpcRouterOutput['getMe']['me']> }) => {
  const trpcUtils = trpc.useContext()
